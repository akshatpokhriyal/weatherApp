          ...
          fetch(baseApiUrl + '/App/User', {
            ...
            .then((res) => {
              ...
              if (res.error_code === 200) {
                ...
                storeData(
                  'user_name',
                  JSON.stringify(res.result.user_firstname),
                );
                storeData(
                  'user_mobile',
                  JSON.stringify(res.result.user_mobile),
                );
                storeData('user_id', JSON.stringify(res.result.user_id));
                storeData('unique_id', JSON.stringify(res.result.unique_id));
                storeData('token', JSON.stringify(res.result.auth_token));
          ...
          fetch(baseApiUrl + '/App/User', {
            ...
            .then((res) => {
              if (res.error_code === 200) {
                ...
                const list = year
                  ? res.result.filter((item) => item.model_year == year)
                  : res.result;

                const list2 = company
                  ? res.result.filter((item) => item.model_make_id == company)
                  : res.result;
                ...
                list.forEach((element) => {
                  if (!_make.includes(element.model_make_id)) {
                    ...
                    make.push({
                      label: element.model_make_id,
                      value: element.model_make_id,
                    });
                  }
                });
                list2.forEach((element) => {
                  ...
                  if (!_trim.includes(element.model_trim)) {
                    ...
                    trim.push({
                      label: element.model_trim,
                      value: element.model_trim,
                    });
                  }
                });
                // console.log(model)
            ...
            .then((res) => {
              ...
              if (res.error_code === 200) {
                ...
                data.forEach((element) => {
                  horsepower.push({
                    label: element.horspower,
                    value: element.horspower,
                  });
                });
